...
class FetchFunctionsJob extends BaseJob implements RetryableJobInterface
{
    /**
     * @var object|null
     */
    ...
    public function execute($queue): void
    {
        ...
        Ats::$plugin->pratoMapper->syncFunctions($response, $this->office);
    }
    ...
    protected function defaultDescription(): string
    {
        ...
        return Craft::t('ats', "Fetching all functions for {$name}");
    }
