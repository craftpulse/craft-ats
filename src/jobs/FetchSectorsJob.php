...
class FetchSectorsJob extends BaseJob implements RetryableJobInterface
{
    /**
     * @var object|null
     */
    ...
    public function execute($queue): void
    {
        ...
        Ats::$plugin->pratoMapper->syncSectors($response, $this->office);
    }
    ...
    protected function defaultDescription(): string
    {
        ...
        return Craft::t('ats', "Fetching all sectors for {$name}");
    }
}